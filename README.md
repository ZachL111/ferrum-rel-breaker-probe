...
ferrum-rel-breaker-probe is a Solidity project for reliability. It focuses on this technical goal: Develop a Solidity command-oriented project for breaker scenarios with node-edge fixtures, cycle and reachability reports, and no network dependency.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 160, risk penalty 6, latency penalty 3, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
